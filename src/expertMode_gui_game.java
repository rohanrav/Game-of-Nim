...
public class expertMode_gui_game extends JFrame {
	...
	public expertMode_gui_game() {
		...
		if (unbeatable_mode == false) {
			stones_inpile = (int)(Math.random() * 15 + 15); //getting random integer for the amount of stones 
		} else {
			stones_inpile = (int)(Math.random() * 15 + 15); //getting random integer for the amount of stones 
			while (stones_inpile == 17 || stones_inpile == 21 || stones_inpile == 25 || stones_inpile == 29) {
				stones_inpile = (int)(Math.random() * 15 + 15); //getting random integer for the amount of stones which is not 17,21,25, or 29. 
			}
		}
